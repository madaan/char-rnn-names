...
|![Model Architecture](https://raw.githubusercontent.com/madaan/char-rnn-names/master/docs/model_example.png)|
|:--:|
...
I think we have discussed a lot, let's recap before we move ahead. 
